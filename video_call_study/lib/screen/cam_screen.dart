...
import 'package:video_call_study/const/agora.dart';
...
class _CamScreenState extends State<CamScreen> {
  ...
  Future<bool> init() async {
    ...
    final cameraPerimission = resp[Permission.camera];
    final micPermission = resp[Permission.microphone];

    if (cameraPerimission != PermissionStatus.granted ||
